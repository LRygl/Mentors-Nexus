...
public class SecurityConstant {
    ...
    public static final String[] PUBLIC_URLS = {"/user/login","/user/list", "/user/register", "/user/resetpassword/**", "/user/image/**"}; //allowed url to be accessed without permissions
